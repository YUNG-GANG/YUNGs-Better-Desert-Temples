...
import com.yungnickyoung.minecraft.betterdeserttemples.util.NoiseSettingsDeepCopier;
...
public class BDTModWorld {
    public static void init() {
        MinecraftForge.EVENT_BUS.addListener(EventPriority.HIGHEST, BDTModWorld::deepCopyDimensionalSpacing);
    }
