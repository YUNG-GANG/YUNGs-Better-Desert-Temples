...
public class BlueConcreteProcessor implements StructureProcessor {
    ...
    public StructureTemplate.StructureBlockInfo processBlock(LevelReader levelReader,
        ...
        if (blockInfo.state().getBlock() == Blocks.CONCRETE.pick(DyeColor.BLUE)) {
            blockInfo = new StructureTemplate.StructureBlockInfo(blockInfo.pos(), Blocks.DYED_TERRACOTTA.pick(DyeColor.BLUE).defaultBlockState(), blockInfo.nbt());
        }
        return blockInfo;
    }
